...
docker build -t docker.pkg.github.com/toresbe/docker_experiments/frontend:0.0.1 ~/frikanalen/packages/frontend/
docker push docker.pkg.github.com/toresbe/docker_experiments/frontend:0.0.1
